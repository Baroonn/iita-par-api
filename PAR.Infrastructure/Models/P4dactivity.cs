...
public partial class P4dactivity
{
    ...
    public virtual ICollection<P4dachievement> P4dachievements { get; set; } = new List<P4dachievement>();

    public virtual P4dworkplan? Workplan { get; set; }
}
